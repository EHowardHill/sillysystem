...
apt update -y
apt install -y build-essential wget libncurses-dev flex bison qemu-system-x86 libelf-dev
...
wget https://busybox.net/downloads/binaries/$VER_BUSYBOX-x86_64-linux-musl/busybox
